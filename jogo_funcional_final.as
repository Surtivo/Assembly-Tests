...
INTERRUPTION_MASK   EQU     	FFFAh			;CORRIGIR COLISÃO COM AS PAREDES PARA NÃO DESMANCHAR UMA PAREDE	
ROW_SHIFT			EQU			8d				;FALTA GARANTIR QUE A FRUTA NÃO VAI SPAWNAR NA COBRA (feito, mas não sei se funciona)
ROW_LIMIT			EQU			24d				
COL_LIMIT_RIGHT		EQU			79d			
...
D_KEY				EQU			3d
R_KEY				EQU			4d
SNAKE_MAX_TAM       EQU         30d
TRUE				EQU			1d
FALSE				EQU			0d
VET_INITIAL_INDEX	EQU			0d
TIC_SPEED			EQU			3d
INITIAL_COL			EQU			0d
END_LINE				EQU			12d
LINE_SPACE_WINDOW 	EQU			20d
LINE_OFFSET			EQU			3d
COL_SPACE_WINDOW	EQU			78d
COL_OFFSET			EQU			1d
INITIAL_SCORE_LINE	EQU			1d
SCORE_UNIT_COL		EQU			74d
SCORE_DEZ_COL		EQU			73d
SCORE_CEM_COL		EQU			72d
SCORE_MIL_COL		EQU			71d
...
CharFruit		WORD	'*'
BlankSpace		WORD	' '
InitialScoreValue 	WORD	':'
ResetValue		WORD	'0'
RowIndex		WORD	0d
ColumnIndex		WORD	0d
TextIndex		WORD	0d

HeadRowPosition	WORD	11d
HeadColPosition	WORD	50d
TailRowPosition	WORD	12d
TailColPosition	WORD	40d
LastKeyPressed	WORD	D_KEY
SnakeHead		TAB		SNAKE_MAX_TAM
SnakeTam        WORD    2d
...
ShiftLoop:  CMP     R2, VET_INITIAL_INDEX
            JMP.Z   EndShift
...
EndScoreMil: 	MOV		R1, INITIAL_SCORE_LINE
				MOV		R2, SCORE_MIL_COL
				SHL		R1, ROW_SHIFT
				OR		R1, R2
				MOV		M[ CURSOR ], R1
				MOV		R3, M [ ScoreMil ]
...
EndScoreCem: 	MOV		R1, INITIAL_SCORE_LINE
				MOV		R2, SCORE_CEM_COL
				SHL		R1, ROW_SHIFT
				OR		R1, R2
				MOV		M[ CURSOR ], R1
				MOV		R3, M [ ScoreCem ]
...
EndScoreDez:	MOV		R1, INITIAL_SCORE_LINE
				MOV		R2, SCORE_DEZ_COL
				SHL		R1, ROW_SHIFT
				OR		R1, R2
				MOV		M[ CURSOR ], R1
				MOV		R3, M [ ScoreDez ]
...
EndScoreUnit:	MOV		R1, INITIAL_SCORE_LINE
				MOV		R2, SCORE_UNIT_COL
				SHL		R1, ROW_SHIFT
				OR		R1, R2
				MOV		M[ CURSOR ], R1
				MOV		R3, M [ ScoreUnit ]
